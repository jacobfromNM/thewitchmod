...
public class WitchModConfig {
        ...
        public static final ForgeConfigSpec.DoubleValue KILL_ZONE_RADIUS;
        public static final ForgeConfigSpec.IntValue AGGRESSION_RAMP_TICKS;
        ...
        static {
                ...
                STARE_TICKS = builder.comment(
                                "Ticks the player must stare to trigger the witch (default = 10 [half a second])")
                                .defineInRange("stareTicks", 10, 1, 60);
                builder.pop();

                builder.comment("Sound Settings").push("sounds");
                PLAY_PROXIMITY_SOUND = builder
                                .comment("Play the proximity sound when the player is near the witch. (default = true)")
